...
class RefreshTokens implements ShouldQueue, ShouldBeUnique
{
     ...
     * @return void
     */
    public function __construct(ApiCredential $apiCredential, string $requestId)
    {
        $this->apiCredential = $apiCredential;

        //Set logging context
        $this->status_context = ['request_id' => $requestId, 'api_credential_id' => $apiCredential->id];
