                    ...
                    <table class="min-w-full border-separate border-spacing-0">
                        ...
                        <tr>
                            <th v-for="(val, index) in titles" scope="col"
                                class="sticky top-0 z-10 border-b border-gray-300 bg-gray-50 bg-opacity-75 py-3.5 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter"
                                :class="[{
                            ...
                            <th scope="col" class="sticky rounded-tr-lg top-0 z-10 border-b border-gray-300 bg-gray-50 bg-opacity-75 py-3.5 pr-4 pl-3 backdrop-blur backdrop-filter sm:pr-6 lg:pr-8">
                        ...
                        <tbody v-if="rows.length > 0">
                            <tr v-for="(row, rowIndex) in rows" :key="row.id" :id="row.id">
                                <td v-for="(item, itemIndex) in row.items" class="whitespace-nowrap py-4 text-sm text-gray-500"
                                    :class="[{
                                        ...
                                        'border-b border-gray-200': rowIndex !== rows.length - 1, // not last row
                                    }, item.class]">
